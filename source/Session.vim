...
set shortmess=aoO
badd +18 js/controller/app.js
badd +3 js/controller/songController.js
badd +1 js/route/songroute.js
badd +1 ~/Dropbox/Icon/emberSound/json/panelsDefault.json
badd +1 hbs/components/tool-bar.hbs
badd +1 em/application.em
badd +1 js/component/side-bar.js
badd +4 hbs/components/mea-sure.hbs
badd +1 js/view/scroll.js
badd +1 js/component/scroll.js
badd +1 hbs/components/menu-bar.hbs
badd +1 hbs/components/a-noteback.hbs
badd +3 em/config.em
badd +3 em/components/pa-nels.em
badd +1 em/components/boolean-switch.em
badd +1 js/component/navigationBar.js
badd +1 hbs/components/ar-peg.hbs
badd +1 hbs/components/scroll.hbs
badd +1 hbs/inventory.hbs
badd +1 hbs/components/sidebar.hbs
badd +1 em/components/panels.em
badd +16 js/utils/compiles.js
badd +54 js/utils/inits.js
badd +1 ~/Dropbox/Icon/emberSound/json/panelsAuth.json
badd +1 hbs/components/measure-bar.hbs
badd +0 js/controller
badd +0 js/component/chordDash.js
badd +1 js/component/optionPanel.js
badd +0 js/component/subbank.js
badd +0 js/component/playBar.js
argglobal
silent! argdel *
argadd js/controller
set stal=2
edit js/route/songroute.js
...
wincmd w
argglobal
edit js/component/chordDash.js
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 18 - ((8 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
18
...
exe '3resize ' . ((&lines * 31 + 33) / 66)
exe 'vert 3resize ' . ((&columns * 88 + 88) / 177)
tabedit hbs/components/tool-bar.hbs
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
exe '4resize ' . ((&lines * 15 + 33) / 66)
exe 'vert 4resize ' . ((&columns * 58 + 88) / 177)
exe '5resize ' . ((&lines * 15 + 33) / 66)
exe 'vert 5resize ' . ((&columns * 58 + 88) / 177)
exe '6resize ' . ((&lines * 15 + 33) / 66)
exe 'vert 6resize ' . ((&columns * 118 + 88) / 177)
exe '7resize ' . ((&lines * 47 + 33) / 66)
exe 'vert 7resize ' . ((&columns * 58 + 88) / 177)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
edit hbs/components/measure-bar.hbs
let s:cpo_save=&cpo
set cpo&vim
imap <buffer>  <Plug>SparkupExecute
imap <buffer>  <Plug>SparkupNext
...
wincmd w
argglobal
edit hbs/components/menu-bar.hbs
let s:cpo_save=&cpo
set cpo&vim
imap <buffer>  <Plug>SparkupExecute
imap <buffer>  <Plug>SparkupNext
...
exe 'vert 1resize ' . ((&columns * 88 + 88) / 177)
exe 'vert 2resize ' . ((&columns * 88 + 88) / 177)
tabedit js/component/subbank.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 45 - ((28 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
...
wincmd w
argglobal
edit js/component/optionPanel.js
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
edit js/controller/songController.js
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 154 - ((35 * winheight(0) + 31) / 63)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
154
...
exe 'vert 2resize ' . ((&columns * 88 + 88) / 177)
exe 'vert 3resize ' . ((&columns * 88 + 88) / 177)
tabedit js/component/playBar.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
