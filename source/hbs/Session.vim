...
silent only
cd ~/Dropbox/Icon/emberSound/source/hbs
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/Dropbox/Icon/emberSound/source/em/application.em
badd +8 components/measure-bar.hbs
badd +5 components/menu-bar.hbs
badd +1 ~/Dropbox/Icon/emberSound/source/scss/tablature.scss
badd +1 components/option-panel.hbs
badd +29 components/chord-dash.hbs
badd +5 ~/Dropbox/Icon/emberSound/source/scss/_properties.scss
badd +5 ~/Dropbox/Icon/emberSound/source/scss/screen.scss
badd +34 ~/Dropbox/Icon/emberSound/source/scss/app.scss
badd +0 ~/Dropbox/Icon/emberSound/source/scss/_settings.scss
badd +28 ~/Dropbox/Icon/emberSound/source/scss/chord.scss
badd +1 components/a-great.hbs
badd +0 components/a-note.hbs
badd +0 components/chord-body.hbs
badd +0 components/ar-peg.hbs
badd +2 lyrics-pane.hbs
badd +1 lyrics.hbs
badd +0 components/lyrics-pane.hbs
argglobal
silent! argdel *
argadd ~/Dropbox/Icon/emberSound/source/em/application.em
set stal=2
edit components/option-panel.hbs
...
silent! normal! zE
let s:l = 35 - ((33 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
normal! 06|
tabedit components/chord-dash.hbs
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
10
normal! 08|
tabedit components/chord-body.hbs
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit components/chord-dash.hbs
let s:cpo_save=&cpo
set cpo&vim
imap <buffer>  <Plug>SparkupExecute
imap <buffer>  <Plug>SparkupNext
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 21 - ((11 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
...
exe '5resize ' . ((&lines * 22 + 24) / 49)
exe 'vert 5resize ' . ((&columns * 66 + 66) / 133)
tabedit components/lyrics-pane.hbs
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
