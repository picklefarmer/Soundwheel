...
exe 'vert 1resize ' . ((&columns * 77 + 79) / 158)
...
exe 'vert 2resize ' . ((&columns * 77 + 79) / 158)
exe 'vert 3resize ' . ((&columns * 78 + 79) / 158)
tabedit ~/Dropbox/Icon/emberSound/source/em/components/pa-nels.em
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
exe 'vert 4resize ' . ((&columns * 77 + 79) / 158)
exe '5resize ' . ((&lines * 28 + 30) / 60)
exe 'vert 5resize ' . ((&columns * 77 + 79) / 158)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
edit ~/Dropbox/Icon/emberSound/source/em/components/boolean-switch.em
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
