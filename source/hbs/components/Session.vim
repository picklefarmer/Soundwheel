...
badd +3 ~/Dropbox/Icon/emberSound/source/em/components/pa-nels.em
...
badd +0 ~/Dropbox/Icon/emberSound/source/em/config/instruments.em
argglobal
silent! argdel *
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 37 - ((29 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
37
