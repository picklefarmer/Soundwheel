App.InstrumentTypeComponent = Em.Component.extend({
	name:null,
	tagName:'canvas',
	...
	//strings number
	color:Em.computed('song.main.fretboard.options',{
		get(){
	...
	height:Em.computed('song.main.strings.options',{
		get(){
	    	var size = 50;
  ...
  //frets number
	width:Em.computed('song.main.frets.options',{
		get(){
		    var size = 61.33; 
		/*	
		 	console.log(`width
	...
	backView:Em.computed('height','width','color',{
	    get(){
    		return this.get('ctx')
    	},
    	set(a,ctx){
